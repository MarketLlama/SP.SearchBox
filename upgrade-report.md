# Upgrade project SP.SearchBox to v1.8.0
...
In file [src/webparts/searchBox/SearchBoxWebPart.manifest.json](src/webparts/searchBox/SearchBoxWebPart.manifest.json) update the code as follows:
...
File: [src/webparts/searchBox/SearchBoxWebPart.manifest.json](src/webparts/searchBox/SearchBoxWebPart.manifest.json)
...
In file [src/webparts/searchBox/SearchBoxWebPart.ts](src/webparts/searchBox/SearchBoxWebPart.ts) update the code as follows:
...
File: [src/webparts/searchBox/SearchBoxWebPart.ts:4:1](src/webparts/searchBox/SearchBoxWebPart.ts)
...
```sh
mkdir /Users/mark/Source/repos/SP.SearchBox/teams_searchBox
```

File: [teams_searchBox](teams_searchBox)
...
```sh
cat > /Users/mark/Source/repos/SP.SearchBox/teams_searchBox/manifest.json << EOF
{
  "$schema": "https://developer.microsoft.com/en-us/json-schemas/teams/v1.2/MicrosoftTeams.schema.json",
  "manifestVersion": "1.2",
  "packageName": "Search Box",
  "id": "2bed3988-d5f3-467d-9615-e6ebac9291c7",
  "version": "0.1",
  "developer": {
    "name": "SPFx + Teams Dev",
  ...
  "description": {
    "short": "SharePoint Search Box",
    "full": "SharePoint Search Box"
  },
  "icons": {
  ...
  "configurableTabs": [
    {
      "configurationUrl": "https://{teamSiteDomain}{teamSitePath}/_layouts/15/TeamsLogon.aspx?SPFX=true&dest={teamSitePath}/_layouts/15/teamshostedapp.aspx%3FopenPropertyPane=true%26teams%26componentId=2bed3988-d5f3-467d-9615-e6ebac9291c7",
...
File: [teams_searchBox/manifest.json](teams_searchBox/manifest.json)
...
```sh
cp /usr/local/lib/node_modules/@pnp/office365-cli/dist/o365/spfx/commands/project/project-upgrade/assets/tab20x20.png /Users/mark/Source/repos/SP.SearchBox/teams_searchBox/tab20x20.png
```

File: [teams_searchBox/tab20x20.png](teams_searchBox/tab20x20.png)
...
```sh
cp /usr/local/lib/node_modules/@pnp/office365-cli/dist/o365/spfx/commands/project/project-upgrade/assets/tab96x96.png /Users/mark/Source/repos/SP.SearchBox/teams_searchBox/tab96x96.png
```

File: [teams_searchBox/tab96x96.png](teams_searchBox/tab96x96.png)
...
#### [src/webparts/searchBox/SearchBoxWebPart.manifest.json](src/webparts/searchBox/SearchBoxWebPart.manifest.json)
...
#### [src/webparts/searchBox/SearchBoxWebPart.ts](src/webparts/searchBox/SearchBoxWebPart.ts)
